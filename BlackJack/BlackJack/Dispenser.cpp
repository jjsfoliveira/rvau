...
void Dispenser::addMaterial(Material m) {
        materials["default"]=m;
}

void Dispenser::addMaterial(string name, Material m)
{
		materials[name]=m;
}

void Dispenser::loadDispenser(){
...
void Dispenser::applyMaterial(string name) {
